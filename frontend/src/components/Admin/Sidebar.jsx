...
const menuItems = [
    { icon: <FaPlus size={18} />, label: "Add Food", to: "/admin/add" },
    { icon: <FaListUl size={18} />, label: "List Foods", to: "/admin/list" },
    { icon: <IoFastFoodOutline size={18} />, label: "Orders", to: "/admin/orders" },
    { icon: <FaUserCircle size={18} />, label: "Profile", to: "/admin/profile" },
];
            ...
            <div className="flex flex-col justify-between h-full py-6 px-4">
                ...
                <nav className="flex flex-col gap-2 flex-1">
                  ...
                  ${isActive
                            ...
                            >
                                <span className={`text-lg ${isActive ? "text-white" : "text-orange-500"}`}>
                                    {item.icon}
                                </span>
